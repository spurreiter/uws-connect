...
export declare function BodyParserMiddleware(
...
export interface App {
  ...
  listen(
    host: uWS.RecognizedString,
    port: number
  ): Promise<uWS.us_listen_socket | false>
...
export interface AppOptions extends uWS.AppOptions {
   ...
   */
  finalHandler?: (
    err: Error | HttpError | undefined | null,
    req: Request,
    res: Response
  ) => void
}
